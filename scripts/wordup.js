...
function addNewWordSubmission(word) {
    ...
    model.wordSubmissions.filter(function(submission) {
...
function render() {
    ...
    // TODO 2
    // Update the curent time remaining on the scoreboard.DONE
    ...
    if (disallowedLetters.length > 0) {
        ...
        // TODO 8
        // append the red letter chips to the form DONE
...
function currentScore() {
    ...
    // TODO 20
    // return the total sum of the word scores DONE
